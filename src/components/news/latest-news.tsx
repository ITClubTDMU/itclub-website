...
const LatestNews = () => {
  ...
  return (
    <div className="not-important-news grid grid-cols-2 gap-node max-sm:grid-cols-1 md:max-w-[900px] mx-auto">
      {data
        ? data?.payload.map((news) => <CardNews key={news._id} data={news} className="" />)
